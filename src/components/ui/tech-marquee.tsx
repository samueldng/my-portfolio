...
const categoryColors: Record<string, string> = {
    language: 'border-green-500/30 text-green-400',
    framework: 'border-green-500/30 text-green-400',
    database: 'border-emerald-500/30 text-emerald-400',
    tool: 'border-amber-500/30 text-amber-400',
    library: 'border-emerald-500/30 text-emerald-400',
};

const categoryDotColors: Record<string, string> = {
    language: 'bg-green-400',
    framework: 'bg-green-400',
    ...
    return (
        <div
            className={cn(
                ...
                'transition-all duration-300 hover:bg-gray-800/90 hover:shadow-lg hover:shadow-green-500/5 hover:scale-105 hover:-translate-y-1',
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap gap-4 mt-6 justify-center md:justify-start">
                {[
                    { label: 'Linguagens', color: 'bg-green-400' },
                    { label: 'Frameworks', color: 'bg-green-400' },
                    { label: 'Banco de Dados', color: 'bg-emerald-400' },
                    { label: 'Bibliotecas', color: 'bg-emerald-400' },
